...
public class ProductLog {
    ...
    private String productLog() {
        ...
        Calendar calendarDate = randomDate("2019-01-01", "2019-10-17");
    ...
    private Calendar  randomDate(String startDate, String endDate){
        ...
        try {
            ...
            long resultTime = (long) (start.getTime() + Math.random() * (end.getTime() - start.getTime()));
